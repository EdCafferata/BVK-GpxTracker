...
class ViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        coordsLabel.minimumScaleFactor = 0.5
    ...
    func addConstraintsToAppTitleBar() {
        ...
        // appTitleLabel: bovenste balk, volledige breedte
        ...
        // coordsLabel: eigen rij direct onder appTitleLabel, volledige breedte

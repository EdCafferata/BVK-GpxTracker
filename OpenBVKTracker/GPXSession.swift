...
//
//  Shared file: this file is also included in the OpenBVKTracker-Watch Extension target.
...
let kGPXCreatorString = "Open BVK Tracker for iOS"

#elseif os(watchOS)
/// GPX creator identifier. Used on generated files identify this app created them.
let kGPXCreatorString = "Open BVK Tracker for watchOS"

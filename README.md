Open BVK Tracker for iOS + WatchOS
===============================================
...
Open BVK Tracker is a GPS logger for iOS (iPhone, iPad, iPod) with offline map cache support. Track your location, add waypoints and send your logs by email as GPX files.
...
## Translate Open BVK Tracker
Open GPX tracker supports language translations (since 1.7.0). [See list of supported languages and how to translate the app into your language](https://github.com/merlos/iOS-Open-BVK-Tracker/wiki/How-to-translate-Open-GPX-Tracker-into-my-language).
...
```
 git clone https://github.com/merlos/iOS-Open-BVK-Tracker.git
```

Then, to test it open `OpenBVKTracker.xcodeproj` with Xcode.
...
![Documentation Status](https://www.merlos.org/iOS-Open-BVK-Tracker/docs/badge.svg)

**[Read Source code documentation](https://www.merlos.org/iOS-Open-BVK-Tracker/docs/index.html)**
...
## GPL License
Open BVK Tracker app for iOS. Copyright (C) 2014-2023  Juan M. Merlos (@merlos) & Contributors
...
Entry on the [OpenStreetMap Wiki](https://wiki.openstreetmap.org/wiki/OpenBVKTracker)
